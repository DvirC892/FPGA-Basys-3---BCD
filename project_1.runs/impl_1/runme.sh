...
HD_PWD='C:/Users/dvir7/BASYS3/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_display.tcl -notrace
